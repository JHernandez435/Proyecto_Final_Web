...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="vistas/bower_components/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css"
        href="vistas/bower_components/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css">

    <link href="vistas/bower_components/jquery.filer/css/jquery.filer.css" type="text/css" rel="stylesheet" />
    <link href="vistas/bower_components/jquery.filer/css/themes/jquery.filer-dragdropbox-theme.css" type="text/css"
        rel="stylesheet" />

    <link rel="stylesheet" type="text/css" href="vistas/css2/component.css">
    ...
    <link rel="stylesheet" type="text/css" href="vistas/pages/dashboard/horizontal-timeline/css/style.css">

    <link rel="stylesheet" type="text/css" href="vistas/pages/dashboard/amchart/css/amchart.css">
...
<body>
            ...
            <nav class="navbar header-navbar pcoded-header" header-theme="theme4">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <a href="index-2.html">
                            <img class="img-fluid" src="images/logo.png" width="200" height="100"alt="Theme-Logo" />
                        </a>
                                            ...
                                            <ul class="mega-mailbox">
                                                ...
                                                <li>
                                                    <a href="#" class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <h5>Localización</h5>
                                                            <small class="text-muted">Encuentra tu ubicación con facilidad 
                                                            </small>
                                                        </div>
                                                    </a>
                                                </li>
                                        ...
                                        <li class="col-sm-3">
                                            ...
                                            <div class="row m-b-20">
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail"
                                                        src="images/mega-menu/01.jpg" alt="Gallery-1">
                                                </div>
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail"
                                                        src="images/mega-menu/02.jpg" alt="Gallery-2">
                                                </div>
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail"
                                                        src="images/mega-menu/03.jpg" alt="Gallery-3">
                                                </div>
                                            </div>
                                            <div class="row m-b-20">
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail"
                                                        src="images/mega-menu/04.jpg" alt="Gallery-4">
                                                </div>
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail"
                                                        src="images/mega-menu/05.jpg" alt="Gallery-5">
                                                </div>
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail"
                                                        src="images/mega-menu/06.jpg" alt="Gallery-6">
                                                </div>
                                            </div>
                            ...
                            <ul class="nav-right">
                                ...
                                <li class="header-notification">
                                    ...
                                    <ul class="show-notification">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center" src="images/user.png"
                                                    alt="Generic placeholder image">
                                                <div class="media-body">
                                                    <h5 class="notification-user">JHernandez</h5>
                            ...
                            <div class="main-friend-list">
                                <div class="media userlist-box" data-id="1" data-status="online"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-circle" src="images/avatar-1.png"
                                            alt="Generic placeholder image">
                                ...
                                <div class="media userlist-box" data-id="2" data-status="online"
                                    ...
                                    title="Lary Doe">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-circle" src="images/task/task-u1.jpg"
                                            alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-circle" src="images/avatar-2.png"
                                            alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="4" data-status="online" data-username="Alia"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-circle" src="images/task/task-u2.jpg"
                                            alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="5" data-status="online" data-username="Suzen"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-circle" src="images/task/task-u3.jpg"
                                            alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="6" data-status="offline"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-circle" src="images/avatar-3.png"
                                            alt="Generic placeholder image">
                                ...
                                <div class="media userlist-box" data-id="7" data-status="online"
                                    ...
                                    title="Irina Shayk">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-circle" src="images/avatar-4.png"
                                            alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="8" data-status="offline"
                                    ...
                                    title="Sara Tancredi">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-circle" src="images/avatar-5.png"
                                            alt="Generic placeholder image">
                                        <div class="live-status bg-danger"></div>
                                    </a>
                                    <div class="media-body">
            ...
            <div class="showChat_inner">
                ...
                <div class="media chat-messages">
                    <a class="media-left photo-table" href="#!">
                        <img class="media-object img-circle m-t-5" src="images/avatar-1.png"
                            alt="Generic placeholder image">
                    </a>
                ...
                <div class="media chat-messages">
                    ...
                    <div class="media-right photo-table">
                        <a href="#!">
                            <img class="media-object img-circle m-t-5" src="images/avatar-2.png"
                                alt="Generic placeholder image">
                        </a>
                    </div>
                </div>
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-40" src="images/user.png" alt="User-Profile-Image">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu active pcoded-trigger">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="active">
                                            <a href="usuariosAd.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.dash.default">Usuarios</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="">
                                            <a href="productosAd.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.dash.ecommerce">Productos</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="">
                                            <a href="envolturas.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.dash.ecommerce">Envolturas</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="">
                                            <a href="blog.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.dash.ecommerce">Blog</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="page-body">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-modal="modal-13"> <i
                                                                class="icofont icofont-plus m-r-5"></i> Añadir Producto
                                                        </button>
                                                    </div>
                                                    <div class="card-block">
                                        ...
                                        <div class="md-modal md-effect-13 addcontact" id="modal-13">
                                            <div class="md-content">
                                                <h3 class="f-26">Crear Producto</h3>
                                                <div>
                                                    <form enctype="multipart/form-data">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i
                                                                    class="icofont icofont-archive"></i></span>
                                                            <input type="text" class="form-control" placeholder="Codigo"
                                                                id="txtCodigo"></input>
                                                            <div class="errores" id="valida-txtCodigo"></div>
                                                        </div>
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="errores" id="valida-txtCategoria"></div>
                                                        </div>
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i
                                                                    class="icofont icofont-animal-cat"></i></span>
                                                            <input type="text" class="form-control" id="txtDescripcion"
                                                                placeholder="Descripcion">
                                                            <div class="errores" id="valida-txtDescripcion"></div>
                                                        </div>
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i
                                                                    class="icofont icofont-user"></i></span>
                                                            <input type="number" class="form-control" id="txtCantidad" placeholder="Cantidad">
                                                            <div class="errores" id="valida-txtCantidad"></div>
                                                        </div>
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i
                                                                    class="icofont icofont-user"></i></span>
                                                            <input type="number" class="form-control" id="txtPrecio" placeholder="Precio">
                                                            <div class="errores" id="valida-txtPrecio"></div>
                                                        </div>
                                                    ...
                                                    <div class="text-center">
                                                        <button type="button"
                                                            ...
                                                            id="btnGuardarProductos">Guardar</button>
                                                        <button type="button"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="txtNombres">Codigo:</label>
                                                                <input type="text" class="form-control"
                                                                    id="txtEditarCodigo">
                                                                <div class="errores" id="valida-txtEditarCodigo"></div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="txtEditarNombre">
                                                                <div class="errores" id="valida-txtEditarNombre"></div>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="txtCategoria">Categoria:</label>
                                                                <input type="text" class="form-control"
                                                                    id="txtEditarCategoria">
                                                                <div class="errores" id="valida-txtEditarCategoria">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="errores" id="valida-txtEditarDescripcion">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="txtEditarCantidad">
                                                                <div class="errores" id="valida-txtEditarCantidad">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="txtEditarPrecio">
                                                                <div class="errores" id="valida-txtEditarPrecio">
                                                                </div>
                                                            </div>

                                                            <div class="form-group">
                                                                <label id="etiquetaImagen">Imagen: </label>
                                                                </br>
                                                                <img id="imgImagen" urlAnterior="" src="" width="200"
                                                                    height="150">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file" class="form-control"
                                                                    id="txtEditarImagen">
                                                                <div class="errores" id="valida-txtEditarImagen"></div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-primary btnGuardar"
                                                            id="btnEditarProductos" idProducto="">Editar Productos</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script src="vistas/bower_components/d3/d3.js"></script>
    <script src="vistas/bower_components/rickshaw/rickshaw.js"></script>

    <script src="vistas/bower_components/raphael/raphael.min.js"></script>
    <script src="vistas/bower_components/morris.js/morris.js"></script>

    <script type="text/javascript" src="vistas/pages/dashboard/horizontal-timeline/js/main.js"></script>

    <script type="text/javascript" src="vistas/pages/dashboard/amchart/js/amcharts.js"></script>
    <script type="text/javascript" src="vistas/pages/dashboard/amchart/js/serial.js"></script>
    <script type="text/javascript" src="vistas/pages/dashboard/amchart/js/light.js"></script>
    <script type="text/javascript" src="vistas/pages/dashboard/amchart/js/custom-amchart.js"></script>
    ...
    <script type="text/javascript"
        src="vistas/bower_components/i18next-browser-languagedetector/i18nextBrowserLanguageDetector.min.js"></script>
    <script type="text/javascript" src="vistas/bower_components/jquery-i18next/jquery-i18next.min.js"></script>

    <script type="text/javascript" src="vistas/pages/dashboard/custom-dashboard.js"></script>
    ...
    <script src="vistas/bower_components/jquery.filer/js/jquery.filer.min.js"></script>
    <script src="vistas/pages/filer/custom-filer.js" type="text/javascript"></script>
    <script src="vistas/pages/filer/jquery.fileuploads.init.js" type="text/javascript"></script>

    <script src="vistas/js2/classie.js"></script>
    <script src="vistas/js2/modalEffects.js"></script>

    <script type="text/javascript" src="vistas/pages/product-list/product-list.js"></script>
    ...
    <script type="text/javascript" src="vistas/js2/pcoded.min.js"></script>
    <script type="text/javascript" src="vistas/js2/demo-12.js"></script>
    <script type="text/javascript" src="vistas/js2/jquery.mCustomScrollbar.concat.min.js"></script>
    <script type="text/javascript" src="vistas/js2/jquery.mousewheel.min.js"></script>

    <!-- Link personalizados  -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
    <script src="https://kit.fontawesome.com/a076d05399.js"></script>

    <script src="vistas/js/tablaProductos.js"></script>
