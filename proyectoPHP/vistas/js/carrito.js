$(document).ready(function() {
    ...
    function pagarPayu() {
        ...
        $(".formPayu input[name='responseUrl']").attr("value", "http://localhost/proyecto3/index.php");
        $(".formPayu input[name='declinedResponseUrl']").attr("value", "http://localhost/proyecto3/Rdeclinada.html");
