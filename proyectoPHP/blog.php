...
<body>
                        ...
                        <div>
                            ...
                            <ul class="nav-right">
                                ...
                                <li class="user-profile header-notification">
                                    <a href="#!">
                                        <img class="img-fluid" src="images/logo.gif" width="65" height="65"
                                            alt="Theme-Logo" />
                            ...
                            <div id="morphsearch" class="morphsearch">
                                <form class="morphsearch-form">
                                    ...
                                    <button class="morphsearch-submit" type="submit"><b>Buscar</b></button>
                                </form>
                                ...
                                <div class="page-wrapper">
                                    <div class="page-header">
                                        <div class="page-header-title">
                                            <h4>ADMINISTRADOR | PUBLICACIONES</h4>
                                        </div>
                                    ...
                                    <div class="page-body">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-modal="modal-13"> <i
                                                                class="icofont icofont-plus m-r-5"></i> Añadir Blog
                                                        </button>
                                                    </div>
                                                    <div class="card-block">
                                                ...
                                                <div>
                                                    <form enctype="multipart/form-data">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="txtFecha"
                                                                placeholder="Fecha">
                                                            <div class="errores" id="valida-txtFecha"></div>
                                                        </div>
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i
                                                    ...
                                                    <div class="text-center">
                                                        <button type="button"
                                                            ...
                                                            id="btnGuardarBlogs">Guardar</button>
                                                        <button type="button"
                                        ...
                                        <!-- Modal -->
                                        <div id="modalEditarBlog" class="modal fade" role="dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="txtEditarFecha">
                                                                <div class="errores" id="valida-txtEditarFecha"></div>
                                                            </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-primary btnGuardar"
                                                            id="btnEditarBlogs" idBlog="">Editar
                                                            Blog</button>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script src="vistas/js/tablaBlog.js"></script>
