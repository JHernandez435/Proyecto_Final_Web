...
<body>
                                ...
                                <div class="page-wrapper">
                                    <div class="page-header">
                                        <div class="page-header-title">
                                            <h4>ADMINISTRADOR | ENVOLTORIOS</h4>
                                        </div>
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Envoltorios</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="page-body">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Listado de Envoltorio</h5>
                                                        <button type="button"
                                                            class="btn btn-primary waves-effect waves-light f-right d-inline-block md-trigger"
                                                            data-modal="modal-13"> <i
                                                                class="icofont icofont-plus m-r-5"></i> Añadir Envoltorio
                                                        </button>
                                                    </div>
                                                    <div class="card-block">
                                        ...
                                        <div class="md-modal md-effect-13 addcontact" id="modal-13">
                                            <div class="md-content">
                                                <h3 class="f-26">Crear Envoltura</h3>
                                                <div>
                                                    <form enctype="multipart/form-data">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="txtEnvoltura"
                                                                placeholder="Categoria">
                                                            <div class="errores" id="valida-txtEnvoltura"></div>
                                                        </div>
                                                    ...
                                                    <div class="text-center">
                                                        <button type="button"
                                                            ...
                                                            id="btnGuardarEnvolturas">Guardar</button>
                                                        <button type="button"
                                        ...
                                        <!-- Modal -->
                                        <div id="modalEditarEnvoltura" class="modal fade" role="dialog">

                                            <div class="modal-dialog">
                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Editar Envolturas</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        <form enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="txtNombre">Envoltura:</label>
                                                                <input type="text" class="form-control"
                                                                    id="txtEditarEnvoltura">
                                                                <div class="errores" id="valida-txtEditarEnvoltura"></div>
                                                            </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-primary btnGuardar"
                                                            id="btnEditarEnvolturas" idEnvoltura="">Editar Envolturas</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script src="vistas/js/tablaEnvoltura.js"></script>
    <script src="vistas/js/envolturas.js"></script>
